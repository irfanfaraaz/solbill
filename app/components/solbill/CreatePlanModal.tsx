...
export function CreatePlanModal({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!name || amount <= 0 || intervalDays <= 0 || gracePeriodDays < 0)
      return;
    ...
    onSubmit({
      ...
      interval: BigInt(Math.floor(intervalDays * 86400)), // Convert days to seconds
      gracePeriod: BigInt(Math.floor(gracePeriodDays * 86400)),
      maxBillingCycles: BigInt(maxCycles),
    });
  };
